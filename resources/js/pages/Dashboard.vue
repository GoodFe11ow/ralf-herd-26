        ...
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            <div class="grid auto-rows-min gap-4 md:grid-cols-3">
                ...
                <div
                    ...
                    <div
                        class="absolute -top-10 right-0 size-28 rounded-full bg-sky-200/35 blur-3xl dark:bg-sky-500/10">
                    </div>
                    <div
                        class="absolute bottom-0 left-0 size-24 rounded-full bg-indigo-200/30 blur-2xl dark:bg-indigo-500/10">
                    </div>
                ...
                <div
                    ...
                    <div
                        class="absolute -bottom-10 left-2 size-28 rounded-full bg-emerald-200/35 blur-3xl dark:bg-emerald-500/10">
                    </div>
                    <div
                        class="absolute top-0 right-0 size-24 rounded-full bg-amber-200/30 blur-2xl dark:bg-amber-500/10">
                    </div>
            ...
            <div
                class="relative min-h-[100vh] flex-1 overflow-hidden rounded-xl border border-sidebar-border/70 bg-gradient-to-br from-violet-50 via-background to-cyan-50 md:min-h-min dark:border-sidebar-border dark:from-violet-950/40 dark:via-background dark:to-cyan-950/30">
                <div
                    class="absolute -top-10 left-10 size-32 rounded-full bg-violet-200/30 blur-3xl dark:bg-violet-500/10">
                </div>
                <div
                    class="absolute bottom-0 right-10 size-28 rounded-full bg-cyan-200/30 blur-3xl dark:bg-cyan-500/10">
                </div>

                <button type="button"
                    class="relative flex h-full w-full flex-col justify-between p-6 text-left transition hover:bg-white/30 dark:hover:bg-white/5"
                    @click="router.get('/games')">
                    <div>
                        <p class="text-sm text-muted-foreground">Custom API</p>
                        <h2 class="mt-2 text-3xl font-semibold">Favorite Games</h2>
                        <p class="mt-3 max-w-xl text-sm text-muted-foreground">
                            Open the games section to browse entries, use filters, and manage your custom API content.
                        </p>
                    </div>

                    <span class="text-lg font-semibold">Open games →</span>
                </button>
            </div>
